...
def main():
    ...
    ## recommendation data
    reco_df = pd.read_csv(DATAPATH + './recommendation.csv')
    #print(reco_df)
    ...
    with open(SERVER_DATA_PATH, "./full.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./serv_issue_rec.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./bank_nps.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./month_nps.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./bank_serv_freq.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./bank_serv_issue_freq.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./whatif_rec_nps.json", "w") as outfile:
    ...
    with open(SERVER_DATA_PATH, "./whatif_bank_nps.json", "w") as outfile:
